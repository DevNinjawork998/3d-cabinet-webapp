...
export const zh: Dictionary = {
	...
	planner: {
		...
		room: {
			...
			openEnds: "两端开放",
			toWalls: "紧靠侧墙",
			noPanelNeededNote: "紧靠侧墙的一端无需加装收边板。",
			panelNeededNote: "每个开放端都会用收边板遮住柜体侧面。",
			doorsAria: "柜门",
			doorsClosed: "关闭柜门",
			doorsOpen: "打开柜门",
			doorsHidden: "隐藏柜门",
	...
	quote: {
		...
		heading: "为这间{room}索取正式报价",
		description:
			"Infinite Cabinet 的设计师会核对您的布局与尺寸，随后致电为您提供确定价格——通常在一个工作日内完成。",
		fullName: "姓名",
		phone: "电话号码（WhatsApp）",
		email: "电子邮箱",
		area: "所在地区",
		remeasureNote: "设计师可能会到场重新测量——最终价格可能与此预估不同。",
		saved: "已保存",
		submitCta: "发送我的设计以索取报价",
